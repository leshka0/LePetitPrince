...
let lights = {
	...
	,directional: new THREE.DirectionalLight( controller.directional, 4 )
	,point: new THREE.PointLight( controller.point, 1 )
}

<<<<<<< HEAD
lights.directional.position.set( -50, 200, -160 )
=======
